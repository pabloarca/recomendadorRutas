...
if (!mapboxgl.supported()) {
  ...
  */
  const url_base = 'assets/data/base.min.pbf',
    url_poi = 'assets/data/poi.min.pbf',
    center_point = [-4.9775, 36.6863],
    bounds = [[-5.140975, 36.571535], [-4.834120, 36.834818]],
  ...
  let selected_points = {},
    path_data,
    poi_data,
    poi_route = { 'type': 'FeatureCollection', 'features': [] };

  fetch(new Request(url_base)).then(response => {
    return response.arrayBuffer();
  }).then(response => {
    path_data = geobuf.decode(new Pbf(response));

    path_network = new PathFinder(path_data, {
      precision: Math.pow(10,-2.5),
  ...
  map.on('load', () => {
    fetch(new Request(url_poi)).then(response => {
      return response.arrayBuffer();
    }).then(response => {
      let data = geobuf.decode(new Pbf(response));

      poi_data = data['features'];
...
},{"geobuf":10,"geojson-path-finder":13,"mapbox-gl":18,"moment":20,"moment/locale/es":19,"pbf":21}],2:[function(require,module,exports){
'use strict';
...
},{"tinyqueue":22}],13:[function(require,module,exports){
'use strict';
...
},{"./compactor":11,"./round-coord":15,"./topology":16,"@turf/distance":2,"turf-point":23}],15:[function(require,module,exports){
...
},{"./round-coord":15,"@turf/explode":3}],17:[function(require,module,exports){
...
},{"ieee754":17}],22:[function(require,module,exports){
'use strict';
